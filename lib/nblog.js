...
exports.init = function(params) {
  ...
  var app, error, server = require('./server');

  server.init(params, function(express, u, p, e) {
    app = express;
    username = u;
    password = p;
    error = e;
...
exports.index = function(req, res) {
  var c, l = exports.checkLoggedIn(req, res);
  ...
  helper.prefs(function(prefs) {
    db.allArticles(prefs.settings.items, function(err, articles) {
      if (err) {
        ...
        res.render('index', data(prefs, l, c));
      }
    });
  });
};
  ...
  helper.prefs(function(prefs) {
    db.findPageByAlias(req.params.c, function(err, content) {
      if (err) {
        ...
        res.render('content', data(prefs, l, c));
      }
    });
  });
};
  ...
  helper.prefs(function(prefs) {
    db.allArticles(100000, function(err, articles) {
      if (err) {
        ...
        res.render('articles', data(prefs, l, c));
      }
    });
  });
};
...
exports.login = function(req, res) {
  ...
  helper.prefs(function(prefs) {
    ...
    res.render('login', data(prefs, false, c));
  });
};
...
exports.add = function(req, res) {
  ...
  helper.prefs(function(prefs) {
    ...
    res.render('edit', data(prefs, l, c));
  });
};
...
exports.addpage = function(req, res) {
  ...
  helper.prefs(function(prefs) {
    ...
    res.render('edit-page', data(prefs, l, c));
  });
};
...
exports.admin = function(req, res) {
  var c, l = true, getlastlog = req.query["login"];
  ...
  helper.prefs(function(prefs) {
    db.allArticlesPages(100000, function(err, articles, pages) {
      if (err) {
        ...
        res.render('admin', data(prefs, l, c));
      }
    });
  }, getlastlog);
};
  ...
  helper.prefs(function(prefs) {
    db.findArticleByDate(
      ...
      function(error, article) {
        ...
        res.render('article', data(prefs, l, c));
    });
  });
};
...
exports.preferences = function(req, res) {
  ...
  helper.prefs(function(prefs) {
    ...
    res.render('preferences', data(prefs, l, c));
  });
};
 ...
 * @api public
 */
exports.data = data = function(prefs, login, content) {
  content.moment = moment;
  content.prefs = prefs;
  content.loggedin = login;
